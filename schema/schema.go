...
type Schema struct {
	...
	createHandler                  func(*Resource)
	updateHandler                  func(*Resource)
	deleteHandler                  func(*Resource)
	RawData                        interface{}
}
...
//SetCreateHandler set handler for creation
func (schema *Schema) SetCreateHandler(handler func(*Resource)) {
	schema.createHandler = handler
}
...
//HandleCreate handle create event
func (schema *Schema) HandleCreate(resource *Resource) {
	if schema.createHandler != nil {
		schema.createHandler(resource)
	}
}

//SetUpdateHandler set handler for update
func (schema *Schema) SetUpdateHandler(handler func(*Resource)) {
	schema.updateHandler = handler
}

//HandleUpdate handle update event
func (schema *Schema) HandleUpdate(resource *Resource) {
	if schema.updateHandler != nil {
		schema.updateHandler(resource)
	}
}

//SetDeleteHandler set handler for delete
func (schema *Schema) SetDeleteHandler(handler func(*Resource)) {
	schema.deleteHandler = handler
}

//HandleDelete handle delete event
func (schema *Schema) HandleDelete(resource *Resource) {
	if schema.deleteHandler != nil {
		schema.deleteHandler(resource)
	}
}
