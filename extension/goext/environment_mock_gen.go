...
// Source: github.com/cloudwan/gohan/extension/goext (interfaces: ICore,ILogger,ISchemas,ISync,IDatabase,ITransaction,IHTTP,IAuth,IConfig,IUtil,IFile)
...
func (m *MockIFile) ReadFile(arg0 string) (string, error) {
...
func (mr *MockIFileMockRecorder) ReadFile(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadFile", reflect.TypeOf((*MockIFile)(nil).ReadFile), arg0)
}
