...
// Source: github.com/cloudwan/gohan/extension/goext (interfaces: ICore,ILogger,ISchemas,ISchema,ISync,IDatabase,ITransaction,IHTTP,IAuth,IConfig,IUtil)
...
func (m *MockISchema) Properties() []Property {
