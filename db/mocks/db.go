...
func (_m *MockDB) BeginTx(_param0 context.Context, _param1 *transaction.TxOptions) (transaction.Transaction, error) {
	ret := _m.ctrl.Call(_m, "BeginTx", _param0, _param1)
	ret0, _ := ret[0].(transaction.Transaction)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (_m *MockDB) Options() options.Options {
	ret := _m.ctrl.Call(_m, "Options")
	ret0, _ := ret[0].(options.Options)
	return ret0
}

func (_mr *_MockDBRecorder) Options() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "Options")
}

func (_m *MockDB) RegisterTable(_param0 *schema.Schema, _param1 bool, _param2 bool) error {
	ret := _m.ctrl.Call(_m, "RegisterTable", _param0, _param1, _param2)
	ret0, _ := ret[0].(error)
	return ret0
}
