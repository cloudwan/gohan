...
func (_m *MockTransaction) SetIsolationLevel(_param0 transaction.Type) error {
	ret := _m.ctrl.Call(_m, "SetIsolationLevel", _param0)
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockTransactionRecorder) SetIsolationLevel(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "SetIsolationLevel", arg0)
}
