...
func etcExtensionsDonburiJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "etc/extensions/donburi.js", size: 18593, mode: os.FileMode(420), modTime: time.Unix(1458706896, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func etcExtensionsDonburiYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "etc/extensions/donburi.yaml", size: 65, mode: os.FileMode(420), modTime: time.Unix(1458706896, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
